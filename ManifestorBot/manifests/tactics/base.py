...
if TYPE_CHECKING:
    from manifestor_bot import ManifestorBot
    from manifests.heuristics import HeuristicState
    from manifests.strategy import Strategy
...
class TacticModule(ABC):
    ...
    def create_behavior(
        ...
        idea: TacticIdea,
        bot: 'ManifestorBot'
    ) -> Optional[object]:  # Returns Ares behavior but we can't import it here
        """
